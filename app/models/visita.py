...
class Visita(models.Model):
    ...
    hora_inicio = models.TimeField(default=lambda: timezone.localtime().time())
    hora_salida = models.TimeField(blank=True, null=True)

    # Guardia/usuario que registra y cierra
    registrado_por = models.ForeignKey(Usuario, on_delete=models.SET_NULL, null=True, blank=True, related_name="visitas_registradas")
    cerrado_por = models.ForeignKey(Usuario, on_delete=models.SET_NULL, null=True, blank=True, related_name="visitas_cerradas")
